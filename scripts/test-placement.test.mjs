 ...
 */
const PENDING = [
  "packages/contracts/test/approach.test.ts",
  "packages/contracts/test/attempt-reinjections.test.ts",
  "packages/contracts/test/attempt.test.ts",
  "packages/contracts/test/authored.test.ts",
  "packages/contracts/test/baseline.test.ts",
  "packages/contracts/test/changeset.test.ts",
  ...
  "packages/contracts/test/lifecycle-reachability.test.ts",
  "packages/contracts/test/limits.test.ts",
  "packages/contracts/test/materialisation.test.ts",
  "packages/contracts/test/merge-carried-approval.test.ts",
  "packages/contracts/test/merge-decision-ids.test.ts",
  "packages/contracts/test/merge-verdict.test.ts",
  "packages/contracts/test/never-read.test.ts",
  "packages/contracts/test/one-piece-of-work.test.ts",
  "packages/contracts/test/plan-nodes.test.ts",
  ...
  "packages/contracts/test/standing.test.ts",
  "packages/contracts/test/stops.test.ts",
  "packages/contracts/test/symbol-index.test.ts",
  "packages/contracts/test/ticket-blocked.test.ts",
