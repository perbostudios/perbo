...
**Merge and publication.** The person merges by default ([D-041](../11-open-decisions.md)), and publishing a branch or pull request needs the person's permission for that run, carried from one run to the next only as [D-129](../11-open-decisions.md) says.
