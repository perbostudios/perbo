import { basename, isAssignment, optionSet, type Context } from "./internal/command.js";
import {
  destinationSentence,
  judgeTarget,
  landed,
...
import { gitFindings } from "./internal/git.js";
import { interpreterFindings, INTERPRETERS } from "./internal/interpreter.js";
import {
  heredocQueue,
  scanSegments,
...
import { linkFindings } from "./internal/link.js";
import {
...
import { programSourceFindings, shellFromStdin } from "./internal/stdin.js";
import {
  EXEC_SPEC,
  KEYWORDS,
  NPX_SPEC,
  ...
  WRAPPERS,
  type WrapperSpec,
} from "./internal/wrappers.js";
import { writerFindings, WRITERS } from "./internal/writers.js";
...
export type { Cwd, ResolvedScope, WorktreeScope } from "./internal/scope.js";
export { splitCommandSegments, withoutHeredocBodies } from "./internal/lexer.js";
