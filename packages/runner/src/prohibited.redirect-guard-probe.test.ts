...
const ROWS: Array<[string, Decision, string]> = [
  ...
  // The words xargs supplies stand where `cp` reads options: refused unless a
  // `--` keeps them paths.
  ["xargs -I{} cp {} <root>/out", "refused", "review-2"],
  ["xargs -I{} cp -- {} <root>/out", "allowed", "supplied-options"],
  ["xargs -0 -n1 cp -t <root>/out", "refused", "review-2"],
  ["xargs -0 -n1 cp -t <root>/out --", "allowed", "supplied-options"],
  ...
  ["xargs -J % cp % <root>/out", "refused", "review-3"],
  ["xargs -J % cp -- % <root>/out", "allowed", "supplied-options"],
  ["xargs -R 2 cp -t <root>/out", "refused", "review-3"],
  ["xargs -R 2 cp -t <root>/out --", "allowed", "supplied-options"],
  ...
  ["ls sub | xargs -I{} cp {} <root>/out", "refused", "xargs-stdin"],
  ["ls sub | xargs -I{} cp -- {} <root>/out", "allowed", "supplied-options"],
  ["ls sub | xargs -0 -n1 cp -t <root>/out", "refused", "xargs-stdin"],
  ["ls sub | xargs -0 -n1 cp -t <root>/out --", "allowed", "supplied-options"],
