...
import { spawnBuilt } from "../src/test-support/built-cli.js";
...
/** `spawnBuilt`'s own margin (`SPAWN_DEADLINE_MS` in `../src/test-support/built-cli.js`) for a cold spawn under load. */
